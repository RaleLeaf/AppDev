        ...
        <div className="hidden md:flex md:flex-col md:w-64 md:border-r border-zinc-800 md:p-6">
          ...
          <nav className="flex-1">
            <div className="space-y-2">
              <button className="flex items-center w-full p-3 rounded-lg bg-zinc-900 text-white group">
              ...
              <button className="flex items-center w-full p-3 rounded-lg text-zinc-400 hover:bg-zinc-900 hover:text-white group">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-auto pt-20">
              ...
              <button className="flex items-center w-full p-3 rounded-lg text-zinc-400 hover:bg-zinc-900 hover:text-white group mt-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
