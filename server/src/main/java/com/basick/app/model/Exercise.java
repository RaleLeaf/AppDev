...
public class Exercise {
    ...
    private String muscleGroup; // primary muscle group targeted
    ...
    private Integer defaultDuration; // in seconds for time-based exercises
    private Integer restTimeSeconds; // rest time between sets
    private Double caloriesPerRep;
    private Double caloriesPerMinute;
    
    // Metadata
    private Boolean isPublic; // Available to all users
    private Boolean isVerified; // Verified by fitness professionals
    private String createdBy; // User ID who created this exercise
    private List<String> tags; // Additional searchable tags
    
    // Popularity metrics
    private Integer usageCount; // How many times this exercise has been used
